...
/*
  { id: 13,
    sub: '16',
    public:
     '{"institution":"Institution for 21","bio":"Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21.Bio for 21."}',
    private: '{}',
    createdAt: '2019-09-04 17:47:24.811 +00:00',
    updatedAt: '2019-09-04 17:47:24.834 +00:00' }
*/
db.mongo.connection.then(async ()=>{
    console.log("connected");
    
    const profile_db = await sqlite.open('/home/hayashis/profile.sqlite', { Promise });
    let profiles = await profile_db.all("SELECT * FROM profiles");
    //console.dir(profiles);
    async.eachSeries(profiles, (profile, next_profile)=>{
        db.mongo.User.findOne({sub: profile.sub}).then(rec=>{
            if(!rec) {
                console.log("no", profile.sub);
                return next_profile();
            }
            rec.markModified("profile");
            if(!rec.profile) rec.profile = {};
            Object.assign(rec.profile.public, JSON.parse(profile.public));
            Object.assign(rec.profile.private, JSON.parse(profile.private));
            rec.save(next_profile);
        });
    }, err=>{
        if(err) throw err;
    });
