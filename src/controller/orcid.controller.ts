    ...
    async callback(@Req() req: Request, @Res() res: Response) {
        ...
        if(userParsedfromCookie) {
            ...
            if(userParsedfromOrcid) {
                const messages = [{
                    type: 'error',
                    message: "Your orcid account is already associated to another account. Please signoff / login with your orcid account."
                }];
            ...
            await this.userService.updatebySub(userParsedfromOrcid.sub, userParsedfromOrcid);
