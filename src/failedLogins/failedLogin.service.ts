...
import { FailedLogin, FailedLoginDocument } from 'src/schema/failedLogin.schema';

@Injectable()
export class FailedLoginService {
    
    constructor(@InjectModel(FailedLogin.name) private failedLoginModel: Model<FailedLoginDocument>) {}
