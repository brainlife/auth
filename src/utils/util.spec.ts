...
import { signJWT, hashPassword, checkPassword, createmailTransport, sendEmail } from './common.utils';
...
describe('UtilTests', () => {
    ...
    describe('hashPassword', () => {
        it('should return an error for common password', () => {
            ...
            expect(hashedPassword).toEqual({message: "This is a top-100 common password - Add another word or two. Uncommon words are better."}); // check if the hashed password is not equal to the password
